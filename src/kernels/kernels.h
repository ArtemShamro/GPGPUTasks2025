...
void sum_04_local_reduction(const gpu::WorkSize& workSize, const gpu::gpu_mem_32u& a, gpu::gpu_mem_32u& b, gpu::gpu_mem_32u& с, unsigned int n);
void sum_05_reduction_one_kernel(const gpu::WorkSize& workSize, const gpu::gpu_mem_32u& a, gpu::gpu_mem_32u& b, unsigned int n);
}
